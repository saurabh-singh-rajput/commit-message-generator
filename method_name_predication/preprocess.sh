...
TRAIN_DIR=data/repos/training_repos
VAL_DIR=data/repos/val_repos
TEST_DIR=data/repos/testing_repos
DATASET_NAME=ml4se
MAX_CONTEXTS=20
WORD_VOCAB_SIZE=130113
PATH_VOCAB_SIZE=91141
TARGET_VOCAB_SIZE=26124
NUM_THREADS=4
PYTHON=python3
###########################################################
